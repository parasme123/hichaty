...
public class Hichaty extends ReactContextBaseJavaModule {
    private static ReactApplicationContext reactContext;
    public static final String LOG_TAG = "Hichaty:Hichaty";
    private static Bundle pendingBundle = null;

    public Hichaty(ReactApplicationContext context) {
        super(context);
    ...
    public void launchMainActivity(String uri) {
        ...
        Log.d("launchIntent", uri);

        try {
            Class<?> activityClass = Class.forName(className);
            Intent activityIntent;
            if (uri != null) {
                Log.d("launchIntent", "hello");
