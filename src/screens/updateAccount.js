...
import { StyleSheet, View, Text, TextInput, TouchableOpacity, Modal, PermissionsAndroid, ScrollView, SafeAreaView } from 'react-native';
...
import { backwhite } from '../assets/changethemeicons';
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colour[1] }]}>
            <ScrollView style={styles.container1}>
                <LinearGradient colors={colour} style={styles.avatar}>
                    {props.route.params.backbtn == true &&
                    ...
                    <View style={{ position: 'relative', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        {/* <TouchableOpacity style={{ position: 'absolute', bottom: 0, right: 0 }}>
                            <SvgXml xml={add} width={40} height={40} style={{ backgroundColor: colour[0], borderRadius: 20 }} onPress={() => CameraControllerClass()} />
                        </TouchableOpacity> */}
